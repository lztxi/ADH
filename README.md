...
| 项目 | 本次数量 | 上次数量 | 变化 |
|------|----------|----------|------|
| 🕐 **更新时间** | 2026-08-25 12:19 UTC | 2026-08-25 | - |
| 📦 **黑名单域名** | 209,855 个 | 209,716 个 | 📈 +139 (+0.07%) |
| 🎯 **白名单域名** | 125 个 | 125 个 | 无变化 |
| 📋 **上游源数量** | 8 个 | - | - |

💡 **变化提示**: 本次黑名单变化 139 条规则
   📈 新增屏蔽 139 个广告域名
...
| AdGuard 中文 | 5,937 | 11 | 23,369 |
| AdGuard DNS Filter（DNS 层拦截广告 / 跟踪器 / 恶意软件） | 176,640 | 11 | 179,203 |
| I-Don't-Care-About-Cookies | 80 | 0 | 24,339 |
| EasyPrivacy（隐私保护 / 跟踪器） | 42,978 | 4 | 56,714 |
| anti-AD（中文区主要规则） | 94,217 | 106 | 94,427 |

---

🔄 **自动更新**：每 12 小时通过 GitHub Actions 自动构建
⏰ **最近构建时间**：2026-08-25 12:19 UTC
