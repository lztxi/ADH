...
| 项目 | 本次数量 | 上次数量 | 变化 |
|------|----------|----------|------|
| 🕐 **更新时间** | 2026-08-29 15:46 UTC | 2026-08-29 | - |
| 📦 **黑名单域名** | 210,138 个 | 210,013 个 | 📈 +125 (+0.06%) |
| 🎯 **白名单域名** | 125 个 | 125 个 | 无变化 |
| 📋 **上游源数量** | 8 个 | - | - |

💡 **变化提示**: 本次黑名单变化 125 条规则
   📈 新增屏蔽 125 个广告域名
...
| AdGuard DNS Filter（DNS 层拦截广告 / 跟踪器 / 恶意软件） | 177,866 | 11 | 180,429 |
| AdGuard 中文 | 5,982 | 11 | 23,411 |
