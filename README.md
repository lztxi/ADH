...
| 项目 | 本次数量 | 上次数量 | 变化 |
|------|----------|----------|------|
| 🕐 **更新时间** | 2026-09-04 15:11 UTC | 2026-09-04 | - |
| 📦 **黑名单域名** | 211,357 个 | 211,183 个 | 📈 +174 (+0.08%) |
| 🎯 **白名单域名** | 125 个 | 125 个 | 无变化 |
| 📋 **上游源数量** | 8 个 | - | - |

💡 **变化提示**: 本次黑名单变化 174 条规则
   📈 新增屏蔽 174 个广告域名
...
| AdGuard DNS Filter（DNS 层拦截广告 / 跟踪器 / 恶意软件） | 179,074 | 11 | 181,638 |
| AdGuard 中文 | 6,049 | 11 | 23,468 |
| anti-AD（中文区主要规则） | 94,628 | 106 | 94,838 |
| EasyPrivacy（隐私保护 / 跟踪器） | 43,030 | 4 | 56,801 |
| I-Don't-Care-About-Cookies | 80 | 0 | 24,339 |

---

🔄 **自动更新**：每 12 小时通过 GitHub Actions 自动构建
⏰ **最近构建时间**：2026-09-04 15:11 UTC
