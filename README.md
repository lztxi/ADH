...
| 项目 | 本次数量 | 上次数量 | 变化 |
|------|----------|----------|------|
| 🕐 **更新时间** | 2026-09-01 15:36 UTC | 2026-09-01 | - |
| 📦 **黑名单域名** | 210,485 个 | 210,274 个 | 📈 +211 (+0.10%) |
| 🎯 **白名单域名** | 125 个 | 125 个 | 无变化 |
| 📋 **上游源数量** | 8 个 | - | - |

💡 **变化提示**: 本次黑名单变化 211 条规则
   📈 新增屏蔽 211 个广告域名
...
| AdGuard 中文 | 6,019 | 11 | 23,454 |
| anti-AD（中文区主要规则） | 94,416 | 106 | 94,626 |
| AdGuard DNS Filter（DNS 层拦截广告 / 跟踪器 / 恶意软件） | 178,213 | 11 | 180,776 |
| I-Don't-Care-About-Cookies | 80 | 0 | 24,339 |
| EasyPrivacy（隐私保护 / 跟踪器） | 43,010 | 4 | 56,766 |

---

🔄 **自动更新**：每 12 小时通过 GitHub Actions 自动构建
⏰ **最近构建时间**：2026-09-01 15:36 UTC
