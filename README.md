...
| 项目 | 本次数量 | 上次数量 | 变化 |
|------|----------|----------|------|
| 🕐 **更新时间** | 2026-09-02 01:30 UTC | 2026-09-01 | - |
| 📦 **黑名单域名** | 210,611 个 | 210,485 个 | 📈 +126 (+0.06%) |
| 🎯 **白名单域名** | 125 个 | 125 个 | 无变化 |
| 📋 **上游源数量** | 8 个 | - | - |

💡 **变化提示**: 本次黑名单变化 126 条规则
   📈 新增屏蔽 126 个广告域名
...
| EasyPrivacy（隐私保护 / 跟踪器） | 43,012 | 4 | 56,768 |
| AdGuard 中文 | 6,025 | 11 | 23,463 |
| I-Don't-Care-About-Cookies | 80 | 0 | 24,339 |
| anti-AD（中文区主要规则） | 94,628 | 106 | 94,838 |
| AdGuard DNS Filter（DNS 层拦截广告 / 跟踪器 / 恶意软件） | 178,345 | 11 | 180,908 |

---

🔄 **自动更新**：每 12 小时通过 GitHub Actions 自动构建
⏰ **最近构建时间**：2026-09-02 01:30 UTC
