...
| 项目 | 本次数量 | 上次数量 | 变化 |
|------|----------|----------|------|
| 🕐 **更新时间** | 2026-08-18 00:25 UTC | 2026-08-17 | - |
| 📦 **黑名单域名** | 209,258 个 | 189,099 个 | 📈 +20159 (+10.66%) |
| 🎯 **白名单域名** | 125 个 | 125 个 | 无变化 |
| 📋 **上游源数量** | 8 个 | - | - |

💡 **变化提示**: 本次黑名单变化 20,159 条规则
   📈 新增屏蔽 20,159 个广告域名
...
| AdGuard 中文 | 6,134 | 11 | 23,567 |
| EasyPrivacy（隐私保护 / 跟踪器） | 42,938 | 4 | 56,649 |
| anti-AD（中文区主要规则） | 94,707 | 106 | 94,917 |
| AdGuard DNS Filter（DNS 层拦截广告 / 跟踪器 / 恶意软件） | 175,775 | 11 | 178,334 |
| I-Don't-Care-About-Cookies | 80 | 0 | 24,339 |

---

🔄 **自动更新**：每 12 小时通过 GitHub Actions 自动构建
⏰ **最近构建时间**：2026-08-18 00:25 UTC
