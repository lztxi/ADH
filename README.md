...
| 项目 | 本次数量 | 上次数量 | 变化 |
|------|----------|----------|------|
| 🕐 **更新时间** | 2026-08-06 13:25 UTC | 2026-08-06 | - |
| 📦 **黑名单域名** | 195,835 个 | 195,674 个 | 📈 +161 (+0.08%) |
...
| EasyPrivacy（隐私保护 / 跟踪器） | 42,741 | 4 | 56,450 |
| I-Don't-Care-About-Cookies | 80 | 0 | 24,339 |
| anti-AD（中文区主要规则） | 96,395 | 106 | 96,605 |
| AdGuard DNS Filter（DNS 层拦截广告 / 跟踪器 / 恶意软件） | 162,380 | 11 | 164,937 |

---

🔄 **自动更新**：每 12 小时通过 GitHub Actions 自动构建
⏰ **最近构建时间**：2026-08-06 13:25 UTC
