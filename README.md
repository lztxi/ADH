...
| 项目 | 本次数量 | 上次数量 | 变化 |
|------|----------|----------|------|
| 🕐 **更新时间** | 2026-09-07 01:22 UTC | 2026-09-06 | - |
| 📦 **黑名单域名** | 212,132 个 | 212,022 个 | 📈 +110 (+0.05%) |
| 🎯 **白名单域名** | 125 个 | 125 个 | 无变化 |
| 📋 **上游源数量** | 8 个 | - | - |

💡 **变化提示**: 本次黑名单变化 110 条规则
   📈 新增屏蔽 110 个广告域名
...
| AdGuard DNS Filter（DNS 层拦截广告 / 跟踪器 / 恶意软件） | 179,844 | 11 | 182,408 |
| AdGuard 中文 | 6,069 | 11 | 23,492 |
