...
| 项目 | 本次数量 | 上次数量 | 变化 |
|------|----------|----------|------|
| 🕐 **更新时间** | 2026-09-07 16:41 UTC | 2026-09-07 | - |
| 📦 **黑名单域名** | 212,253 个 | 212,132 个 | 📈 +121 (+0.06%) |
| 🎯 **白名单域名** | 125 个 | 125 个 | 无变化 |
| 📋 **上游源数量** | 8 个 | - | - |

💡 **变化提示**: 本次黑名单变化 121 条规则
   📈 新增屏蔽 121 个广告域名
...
| AdGuard 中文 | 6,076 | 11 | 23,502 |
| cjx-annoyance（弹窗 / 跳转 / 自我推广） | 114 | 0 | 1,861 |
| EasyPrivacy（隐私保护 / 跟踪器） | 43,031 | 4 | 56,797 |
| AdGuard DNS Filter（DNS 层拦截广告 / 跟踪器 / 恶意软件） | 175,916 | 11 | 178,480 |
