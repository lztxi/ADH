...
| 项目 | 本次数量 | 上次数量 | 变化 |
|------|----------|----------|------|
| 🕐 **更新时间** | 2026-08-21 12:18 UTC | 2026-08-21 | - |
| 📦 **黑名单域名** | 209,092 个 | 208,934 个 | 📈 +158 (+0.08%) |
| 🎯 **白名单域名** | 125 个 | 125 个 | 无变化 |
| 📋 **上游源数量** | 8 个 | - | - |

💡 **变化提示**: 本次黑名单变化 158 条规则
   📈 新增屏蔽 158 个广告域名
...
| EasyPrivacy（隐私保护 / 跟踪器） | 42,957 | 4 | 56,675 |
| AdGuard 中文 | 6,177 | 11 | 23,620 |
| AdGuard DNS Filter（DNS 层拦截广告 / 跟踪器 / 恶意软件） | 176,829 | 11 | 179,392 |
