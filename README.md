...
| 项目 | 本次数量 | 上次数量 | 变化 |
|------|----------|----------|------|
| 🕐 **更新时间** | 2026-08-23 00:27 UTC | 2026-08-22 | - |
| 📦 **黑名单域名** | 209,164 个 | 209,299 个 | 📉 -135 (-0.06%) |
| 🎯 **白名单域名** | 125 个 | 125 个 | 无变化 |
| 📋 **上游源数量** | 8 个 | - | - |

💡 **变化提示**: 本次黑名单变化 135 条规则
   📉 移除屏蔽 135 个域名（可能已失效）
...
|------|------|--------|--------|
| 秋风（适配路由器） | 897 | 0 | 913 |
| AdGuard 中文 | 5,902 | 11 | 23,333 |
| cjx-annoyance（弹窗 / 跳转 / 自我推广） | 114 | 0 | 1,861 |
| AdGuard DNS Filter（DNS 层拦截广告 / 跟踪器 / 恶意软件） | 176,897 | 11 | 179,460 |
| 大萌主（轻量去除色情 / 悬浮广告） | 4,496 | 4 | 5,899 |
| EasyPrivacy（隐私保护 / 跟踪器） | 42,964 | 4 | 56,683 |
