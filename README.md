...
| 项目 | 本次数量 | 上次数量 | 变化 |
|------|----------|----------|------|
| 🕐 **更新时间** | 2026-08-26 12:21 UTC | 2026-08-26 | - |
| 📦 **黑名单域名** | 209,189 个 | 209,048 个 | 📈 +141 (+0.07%) |
| 🎯 **白名单域名** | 125 个 | 125 个 | 无变化 |
| 📋 **上游源数量** | 8 个 | - | - |

💡 **变化提示**: 本次黑名单变化 141 条规则
   📈 新增屏蔽 141 个广告域名
...
|------|------|--------|--------|
| 秋风（适配路由器） | 897 | 0 | 913 |
| AdGuard 中文 | 5,945 | 11 | 23,375 |
| cjx-annoyance（弹窗 / 跳转 / 自我推广） | 114 | 0 | 1,861 |
| 大萌主（轻量去除色情 / 悬浮广告） | 4,496 | 4 | 5,899 |
| AdGuard DNS Filter（DNS 层拦截广告 / 跟踪器 / 恶意软件） | 176,931 | 11 | 179,494 |
| EasyPrivacy（隐私保护 / 跟踪器） | 42,984 | 4 | 56,719 |
