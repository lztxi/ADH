...
| 项目 | 本次数量 | 上次数量 | 变化 |
|------|----------|----------|------|
| 🕐 **更新时间** | 2026-08-05 13:27 UTC | 2026-08-05 | - |
| 📦 **黑名单域名** | 195,542 个 | 195,374 个 | 📈 +168 (+0.09%) |
| 🎯 **白名单域名** | 125 个 | 125 个 | 无变化 |
| 📋 **上游源数量** | 8 个 | - | - |

💡 **变化提示**: 本次黑名单变化 168 条规则
   📈 新增屏蔽 168 个广告域名
...
| AdGuard DNS Filter（DNS 层拦截广告 / 跟踪器 / 恶意软件） | 162,087 | 11 | 164,643 |
| EasyPrivacy（隐私保护 / 跟踪器） | 42,738 | 4 | 56,447 |
