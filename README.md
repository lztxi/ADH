...
| 项目 | 本次数量 | 上次数量 | 变化 |
|------|----------|----------|------|
| 🕐 **更新时间** | 2026-08-04 09:19 UTC | 2026-08-04 | - |
| 📦 **黑名单域名** | 195,195 个 | 195,178 个 | 📈 +17 (+0.01%) |
...
| AdGuard DNS Filter（DNS 层拦截广告 / 跟踪器 / 恶意软件） | 161,741 | 11 | 164,292 |

---

🔄 **自动更新**：每 12 小时通过 GitHub Actions 自动构建
⏰ **最近构建时间**：2026-08-04 09:19 UTC
