...
# channel as default.
#
# --mirror <Aliyun|tsinghua>
#
# Use the --mirror option to install from a mirror supported by this script.
# Available mirrors are "Aliyun" (https://mirrors.aliyun.com/docker-ce), and
# "tsinghua" (https://mirror.azure.cn/docker-ce), for example:
#
#   $ sudo sh install-docker.sh --mirror tsinghua
#
# ==============================================================================
...
case "$mirror" in
	...
	"")
		;;
	*)
		>&2 echo "unknown mirror '$mirror': use either 'Aliyun', or 'tsinghua'."
		exit 1
		;;
esac
